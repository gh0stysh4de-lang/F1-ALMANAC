...
const NAV_ITEMS = [
  ...
  { label: 'Drivers', href: '/drivers', enabled: false },
  { label: 'Constructors', href: '/constructors', enabled: false },
  { label: 'Circuits', href: '/circuits', enabled: false },
] as const
...
const HEADER_PRIMARY_SOFT = 'rgba(199, 197, 208, 0.78)'
...
export function AlmanacHeader({ season, onSeasonChange, mode, onModeChange }: Props) {
